...
primitive seq3rs (IQ, SN, RN, nextstate, CK, NOTIFIER);
  output IQ;
  input SN;
  input RN;
  input nextstate;
...
module DFFRS_X1 (CK, D, RN, SN, Q, QN);
  ...
  seq3rs(IQ, SN, RN, nextstate, CK, NOTIFIER);
  and(IQN, i_15, i_16);
  not(i_15, IQ);
  not(i_16, i_17);
  and(i_17, i_18, i_19);
...
primitive seq3sr (IQ, SN, RN, nextstate, CK, NOTIFIER);
  output IQ;
  input SN;
  input RN;
  input nextstate;
...
module DFFRS_X2 (CK, D, RN, SN, Q, QN);
  ...
  seq3sr(IQ, SN, RN, nextstate, CK, NOTIFIER);
  and(IQN, i_15, i_16);
  not(i_15, IQ);
  not(i_16, i_17);
  and(i_17, i_18, i_19);
...
primitive seq3r (IQ, RN, nextstate, CK, NOTIFIER);
  output IQ;
  input RN;
  input nextstate;
  input CK;
...
module DFFR_X1 (CK, D, RN, Q, QN);
  ...
  seq3r(IQ, RN, nextstate, CK, NOTIFIER);
  not(IQN, IQ);
  buf(Q, IQ);
  buf(QN, IQN);
  buf(nextstate, D);
...
primitive seq3s (IQ, SN, nextstate, CK, NOTIFIER);
  output IQ;
  input SN;
  input nextstate;
  input CK;
...
module DFFS_X1 (CK, D, SN, Q, QN);
  ...
  seq3s(IQ, SN, nextstate, CK, NOTIFIER);
  not(IQN, IQ);
  buf(Q, IQ);
  buf(QN, IQN);
  buf(nextstate, D);
...
primitive seq3l(IQ, nextstate, G, NOTIFIER);
  output IQ;
  input nextstate;
  input G;
  input NOTIFIER;
