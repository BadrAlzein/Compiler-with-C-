...
private:
	...
	/**	Behandelt das Dr�cken einer Taste.
	 */
	void keyHit();

	/**	Bestimmt das Zeichen, gem�� der Codetabelle.
	 */
	void determineAsciiCode();

	/**	F�hrt den software reboot aus.
	 */
	void reboot();
	...
	/**	Hilfsfunktionen f�r den Zugriff auf den Tastaturcontroller
	 */
	void waitForRead();
	void waitForWrite();
};
