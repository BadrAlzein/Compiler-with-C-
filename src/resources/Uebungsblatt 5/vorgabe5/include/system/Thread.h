 ...
 *
 *	Beachte, dass Thread private von Activity erbt, in abgeleiteten Klassen
...
public:
	Thread(int slice=1) // : Activity()
    {
        Activity::quantum(slice);
	}
	...
	static Thread* self()
	{
	    return (Thread*) scheduler.activeElement;
	}
