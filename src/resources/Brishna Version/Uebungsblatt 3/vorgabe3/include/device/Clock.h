...
public:
	 ...
	 *  Edit Robert:
	 *		Das bedeutet, 'tick' inkrementieren
	 *		Zu einem geeigneten Zeitpunkt muss 'tick' auf 0 setzen.
	 *		Außerdem muss geschrieben werden, was beim Interrupt gemacht werden soll.
	 *
