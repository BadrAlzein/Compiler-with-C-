...
public:
    ...
    /**
      ...
      *       Ein ASCII-Zeichen.
      * @return
      *       True wenn es sich um ein Operator-Zeichen handelt, sonst false.
      */
    ...
    /**
      ...
      *       Ein ASCII-Zeichen.
      * @return
      *       True wenn es sich um ein Hexadezimal-Zeichen handelt, sonst false.
      */
    bool isHex(char ch);
    ...
    /**
      ...
      *       Ein ASCII-Zeichen.
      * @return
      *       True wenn es sich um ein Klammer-Zeichen handelt, sonst false.
      */
    ...
    /**
      ...
      *       Ein ASCII-Zeichen.
      * @return
      *       True wenn es sich um ein NichtHexadezimal-Zeichen handelt, sonst false.
      */
