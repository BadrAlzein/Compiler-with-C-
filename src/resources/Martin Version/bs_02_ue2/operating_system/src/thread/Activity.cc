 ...
 * weil sonst Fehler
 * */
Activity::Activity(void *tos) // Initialer Zustand ist blocked, damit der Thread nicht sofort läuft
 ...
 * aufgerufen werden.
 */
Activity::Activity() // Verpacken des aktuellen Kontrollflusses als Thread. void *tos = 0, //Zustand Blocked, damit Activity/Thread nicht sofort läuft
